...
describe PeakFlowUtils::ValidationsHandler do
  let(:validations_handler) { PeakFlowUtils::ValidationsHandler.new }
  ...
  it "#groups" do
    expect(validations_handler.groups.to_a.length).to eq 12
  end
